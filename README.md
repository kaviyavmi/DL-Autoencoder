...
To train the model to remove noise, Gaussian noise is added to the clean images, and the network learns to recover the original from the noisy version. The training process uses Mean Squared Error (MSE) as the loss function to measure the reconstruction error and the Adam optimizer to update the model weights.

The autoencoder is trained over multiple epochs using mini-batches of data for efficiency. After training, the model's performance is visually evaluated by displaying the original, noisy, and denoised images side by side.
...
<img width="645" height="461" alt="image" src="https://github.com/user-attachments/assets/913190fa-a927-49a8-9b53-e2aa9ae7c531" />


### Training loss

<img width="316" height="146" alt="image" src="https://github.com/user-attachments/assets/357e44b4-810f-48d0-96f5-3aaa416b70b1" />


## Original vs Noisy Vs Reconstructed Image

<img width="1677" height="586" alt="image" src="https://github.com/user-attachments/assets/39a926bf-9e94-4a23-b5ed-a006f738f70a" />
